      ...
      >
        {showMobileContent ? (
          <div className="h-full flex flex-col justify-between space-y-2 animate-fade-in transition-all duration-700 py-1">
            ...
            {/* 5 Rows of 2-Column Cards Equally Distributed Vertically with 30% Bottom Padding */}
            <div className="flex-1 flex flex-col justify-between space-y-1.5 py-1 pb-[30%]">
          ...
          <div className="h-full flex items-start justify-center pt-[60vh] animate-pulse">
